...
#define DISPL_LED_Pin GPIO_PIN_1
 ...
 ***************************************************/
#define DISPL_PRESCALER SPI_BAUDRATEPRESCALER_16     //prescaler assigned to display SPI port
 ...
 ***************************************************/
#define DISPL_DMA_CUTOFF 	10000000    // (bytes) used only in DMA_MODE
