...
#define CENTRE_ANGLE 0 // NEED GO CHECK
#define ZERO 1.86669159f //checking
#define RIGHT_YAW_LIMIT ZERO + (10.0f *DEG2RAD)  //NEED TO CHECK COULD BE INVERTED
#define LEFT_YAW_LIMIT ZERO - (10.0f *DEG2RAD) //NEED TO CHECK COULD BE INVERTED
