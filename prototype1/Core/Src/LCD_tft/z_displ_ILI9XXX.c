...
typedef struct _lv_display_t lv_display_t; //this is called forward declaration
...
extern volatile uint8_t Displ_SpiAvailable=1;  			// 0 if SPI is busy or 1 if it is free (transm cplt)
...
void Displ_Init(Displ_Orientat_e orientation){
	...
	// --- ILI9486 init snippet using your helpers ---
...
//	HAL_Delay(120);
//
//	 Displ_WriteCommand(0x01);                   // SWRESET
//	 HAL_Delay(120);
//
//	// Exit Sleep
...
//	Displ_WriteData((uint8_t[]){0x00,0x03,0x09,0x08,0x16,0x0A,0x3F,0x78,0x4C,0x09,0x0A,0x08,0x16,0x1A,0x0F}, 15, 0);
//
//	// Negative Gamma Control
//	Displ_WriteCommand(0xE1);
//	Displ_WriteData((uint8_t[]){0x00,0x16,0x19,0x03,0x0F,0x05,0x32,0x45,0x46,0x04,0x0E,0x0D,0x35,0x37,0x0F}, 15, 0);
//
//	// Power Control 1
//	Displ_WriteCommand(0xC0);
//	Displ_WriteData((uint8_t[]){0x17,0x15}, 2, 0);
//
//	// Power Control 2
//	Displ_WriteCommand(0xC1);
//	Displ_WriteData((uint8_t[]){0x41}, 1, 0);
//
//	// VCOM Control
//	Displ_WriteCommand(0xC5);
//	Displ_WriteData((uint8_t[]){0x00,0x12,0x80}, 3, 0);
//
//	// Memory Access Control (MADCTL)
//	Displ_WriteCommand(0x36);
//	Displ_WriteData((uint8_t[]){0x48}, 1, 0);   // MX + BGR. Try 0x28/0xE8 if rotation/colors off
//
//	// Pixel Interface Format (COLMOD)
//	Displ_WriteCommand(0x3A);
//	Displ_WriteData((uint8_t[]){0x55}, 1, 0);   // *** ILI9486 SPI = 16-bit RGB565 ***
//
//	// Interface Mode Control
//	Displ_WriteCommand(0xB0);
//	Displ_WriteData((uint8_t[]){0x00}, 1, 0);
//
//	// Frame Rate Control
//	Displ_WriteCommand(0xB1);
//	Displ_WriteData((uint8_t[]){0xA0}, 1, 0);
//
//	// Display Inversion Control
//	Displ_WriteCommand(0xB4);
//	Displ_WriteData((uint8_t[]){0x02}, 1, 0);
//
//	// Display Function Control
//	Displ_WriteCommand(0xB6);
//	Displ_WriteData((uint8_t[]){0x02,0x02,0x3B}, 3, 0);
//
//	// Entry Mode Set
//	Displ_WriteCommand(0xB7);
//	Displ_WriteData((uint8_t[]){0xC6}, 1, 0);
//
//	// Adjust Control 3
//	Displ_WriteCommand(0xF7);
//	Displ_WriteData((uint8_t[]){0xA9,0x51,0x2C,0x82}, 4, 0);
//
//
//
//	// Display ON
...
//	Displ_WriteCommand(0x3A);
//	uint8_t colmod = 0x66;   // 16bpp (RGB565)
//	Displ_WriteData(&colmod, 1, 0);
//
//	// Memory Access Control (orientation + color order)
//	Displ_WriteCommand(0x36);
//	uint8_t madctl = 0x48;   // MX + BGR (common default)
//	Displ_WriteData(&madctl, 1, 0);
//
//	// Frame Rate
//	Displ_WriteCommand(0xB1);
//	uint8_t fr = 0xA0;
//	Displ_WriteData(&fr, 1, 0);
//
//	// Display Inversion Control
//	Displ_WriteCommand(0xB4);
//	uint8_t inv = 0x02;      // 2-dot inversion
//	Displ_WriteData(&inv, 1, 0);
//
//	// Display Function Control
//	Displ_WriteCommand(0xB6);
//	uint8_t dfc[3] = {0x02,0x02,0x3B};
//	Displ_WriteData(dfc, 3, 0);
//
//	// Interface Mode Control (stay in serial)
//	Displ_WriteCommand(0xB0);
//	uint8_t ifm = 0x00;
//	Displ_WriteData(&ifm, 1, 0);
//
//	// Vendor adjust control 3
//	Displ_WriteCommand(0xF7);
//	uint8_t adj[4] = {0xA9,0x51,0x2C,0x82};
//	Displ_WriteData(adj, 4, 0);
//
//	// Display ON
//	Displ_WriteCommand(0x29);
//	HAL_Delay(25);
